...
import { Database, Tables, TablesInsert } from '../_shared/db.types.ts';
...
export const syncPlaylists = async (
  ...
  // calculate playlist items from req
  const allPlaylistItems: Tables<'playlist_items'>[] = playlists.flatMap(
    (playlist) => {
